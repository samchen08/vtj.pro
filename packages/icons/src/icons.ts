...
export const VtjIconCollapsed = createIconComponent('VtjIconCollapsed', 'vtj-icon-collapsed');
export const VtjIconExpand = createIconComponent('VtjIconExpand', 'vtj-icon-expand');
export const VtjIconEnv = createIconComponent('VtjIconEnv', 'vtj-icon-env');
export const VtjIconBottomPanel = createIconComponent('VtjIconBottomPanel', 'vtj-icon-bottom-panel');
export const VtjIconTopPanel = createIconComponent('VtjIconTopPanel', 'vtj-icon-top-panel');
export const VtjIconRightPanel = createIconComponent('VtjIconRightPanel', 'vtj-icon-right-panel');
export const VtjIconLeftPanel = createIconComponent('VtjIconLeftPanel', 'vtj-icon-left-panel');
export const VtjIconDevTools = createIconComponent('VtjIconDevTools', 'vtj-icon-dev-tools');
export const VtjIconPageSetting = createIconComponent('VtjIconPageSetting', 'vtj-icon-page-setting');
export const VtjIconDiff = createIconComponent('VtjIconDiff', 'vtj-icon-diff');
export const VtjIconLang = createIconComponent('VtjIconLang', 'vtj-icon-lang');
export const VtjIconConfig = createIconComponent('VtjIconConfig', 'vtj-icon-config');
export const VtjIconOpenapi = createIconComponent('VtjIconOpenapi', 'vtj-icon-openapi');
export const VtjIconSwagger = createIconComponent('VtjIconSwagger', 'vtj-icon-swagger');
export const VtjIconGlobal = createIconComponent('VtjIconGlobal', 'vtj-icon-global');
export const VtjIconMaster = createIconComponent('VtjIconMaster', 'vtj-icon-master');
