...
| 依赖包                   | 版本                   | 功能说明         |
| ------------------------ | ---------------------- | ---------------- |
| @dcloudio/uni-app        | 3.0.0-5000720260410001 | UniApp 框架核心  |
| @dcloudio/uni-components | 3.0.0-5000720260410001 | 标准组件库       |
| @dcloudio/uni-h5         | 3.0.0-5000720260410001 | H5 平台适配器    |
| @dcloudio/uni-mp-weixin  | 3.0.0-5000720260410001 | 微信小程序适配器 |
